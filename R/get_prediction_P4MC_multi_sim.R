...
get_prediction_P4MC_sim <- function(j, test_data, samples_y0, samples_y1, fit_model, classifier = 'logistic') {
  ...
  # 6. Bayesian integration inference
  p0 <- mean(1 - prob_1_under_input0)
  p1 <- mean(prob_1_under_input1)
